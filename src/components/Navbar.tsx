...
export function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="flex items-center gap-1 md:gap-4 px-4 py-2 bg-white/70 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border border-slate-300 dark:border-white/10 rounded-full shadow-lg">
