...
import { Code2, User, Briefcase, Mail, Award } from "lucide-react";
...
export function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="flex items-center gap-1 md:gap-4 px-4 py-2 bg-white/70 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-full shadow-lg">
        ...
        <div className="hidden md:flex items-center gap-6 px-4 text-sm font-medium text-slate-600 dark:text-gray-300">
          ...
          <Link href="/#certifications" className="hover:text-fuchsia-500 transition-colors">Certifications</Link>
        ...
        <div className="flex md:hidden items-center gap-4 px-2 text-slate-600 dark:text-gray-300">
          <Link href="/#about"><User className="w-5 h-5 hover:text-fuchsia-500" /></Link>
          <Link href="/#projects"><Code2 className="w-5 h-5 hover:text-fuchsia-500" /></Link>
          <Link href="/#certifications"><Award className="w-5 h-5 hover:text-fuchsia-500" /></Link>
          <Link href="/#journey"><Briefcase className="w-5 h-5 hover:text-fuchsia-500" /></Link>
          <Link href="/#contact"><Mail className="w-5 h-5 hover:text-fuchsia-500" /></Link>
        </div>
